<template>
  <div class="page">
    <div>
      <h2>{{ iban.title }}</h2>
      <span>Set nationality_country_code to</span>
      ...
      <EditBankAccount
        :sync_integration="iban.employee.sync_integration"
        :bank_account_iban="iban.employee.bank_account_iban"
        :nationality_country_code="iban.nationality_country_code"
      />
      <h2>{{ iban_existing.title }}</h2>
      <EditBankAccount
        :sync_integration="iban_existing.employee.sync_integration"
        :bank_account_iban="iban_existing.employee.bank_account_iban"
        :nationality_country_code="iban_existing.nationality_country_code"
      />
      <h2>{{ freelancer.title }}</h2>
      <EditBankAccount
        :sync_integration="freelancer.employee.sync_integration"
        :bank_account_iban="freelancer.employee.bank_account_iban"
        :nationality_country_code="freelancer.nationality_country_code"
      />
      <h2>{{ freelancer_existing.title }}</h2>
      <EditBankAccount
        :sync_integration="freelancer_existing.employee.sync_integration"
        :bank_account_iban="freelancer_existing.employee.bank_account_iban"
        :nationality_country_code="freelancer_existing.nationality_country_code"
      />
    </div>
  </div>
</template>
